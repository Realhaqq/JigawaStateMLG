    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 mb-4 mb-lg-0">
                <!-- <a class="footer-brand mr-lg-5 d-flex" href="index"> -->
                    <img src="front/assets/img/ministry.png" height="35" class="mr-3" alt="Footer logo">
                <!-- </a> -->
                <p class="my-4">The Ministry ensures the co-ordination as well as the implementation of State Government Policies as they affect Local Government Councils.</p>
            ...
            <div class="col-6 col-sm-3 col-lg-2 mb-4 mb-lg-0">
                ...
                <ul class="links-vertical">
                    ...
                    <li><a target="_blank" href="#">e-Documents</a></li>
                    <li><a target="_blank" href="#">e-Procurment</a></li>
                </ul>
            </div>
            <div class="col-6 col-sm-3 col-lg-2 mb-4 mb-lg-0">
                <h6>Other Links</h6>
                <ul class="links-vertical">
                    ...
                    <li><a target="_blank" href="#">License</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="row">
            <div class="col pb-4 mb-md-0">
                <div class="d-flex text-center justify-content-center align-items-center">
                    <p class="font-weight-normal mb-0">© <a href="https://themesberg.com?ref=creativetim*" target="_blank">Jigawa State MLG</a> & <a href="https://jigawastatemlg.ng">Jigawa State Government</a> <span class="current-year"></span>. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
